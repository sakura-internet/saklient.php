	...
	public function testCrud()
	{
		...
		if (!self::USE_STATIC_RESOURCE) {
			...
			foreach ($plans as $plan) {
				$this->assertInstanceOf("Saklient\\Cloud\\Resource\\RouterPlan", $plan);
		...
		$this->assertInstanceOf("Saklient\\Cloud\\Resource\\Swytch", $swytch);
		$this->assertGreaterThan(0, count($swytch->ipv4Nets));
		$this->assertInstanceOf("Saklient\\Cloud\\Resource\\Ipv4Net", $swytch->ipv4Nets[0]);
		...
		$this->assertInstanceOf("Saklient\\Cloud\\Resource\\Ipv6Net", $v6net);
		...
		$this->assertInstanceOf("Saklient\\Cloud\\Resource\\Ipv4Net", $sroute);
