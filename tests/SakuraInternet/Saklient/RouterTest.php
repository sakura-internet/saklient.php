...
namespace SakuraInternet\Saklient\Tests;

require_once "Common.php";
use SakuraInternet\Saklient\Cloud\API;
use SakuraInternet\Saklient\Cloud\Enums\ERouterInstanceStatus;
use SakuraInternet\Saklient\Errors\HttpConflictException;
use SakuraInternet\Saklient\Cloud\Resource\Router;

class RouterTest extends \PHPUnit_Framework_TestCase
{
	use \SakuraInternet\Saklient\Tests\Common;
	...
	public function testCrud()
	{
		...
		if (!self::USE_STATIC_RESOURCE) {
			...
			foreach ($plans as $plan) {
				$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\RouterPlan", $plan);
		...
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\Swytch", $swytch);
		$this->assertGreaterThan(0, count($swytch->ipv4Nets));
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\Ipv4Net", $swytch->ipv4Nets[0]);
		...
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\Ipv6Net", $v6net);
		...
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\Ipv4Net", $sroute);
