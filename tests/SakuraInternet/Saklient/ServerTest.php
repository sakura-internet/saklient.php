...
class ServerTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testFind(API $api)
	{
		...
		foreach ($servers as $server) {
			$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\Server", $server);
			$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\ServerPlan", $server->plan);
	...
	public function testCrud(API $api)
	{
		...
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\Iface", $iface);
		...
		$disk->source = null;
		$disk->reload();
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\Archive", $disk->source);
		...
		if (self::TESTS_DUPLICATE_DISK) {
			...
			$disk2->source = null;
			$disk2->reload();
			$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\Disk", $disk2->source);
