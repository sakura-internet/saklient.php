...
class IsoImageTest extends \PHPUnit_Framework_TestCase
{
	...
	public function testCreate(API $api)
	{
		...
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\IsoImage", $iso);
		$iso->name = $name;
		...
		//
		$ftp = $iso->ftpInfo;
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\FtpInfo", $ftp);
		...
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\FtpInfo", $ftp2);
	...
	public function testInsertEject(API $api)
	{
		...
		$this->assertInstanceOf("SakuraInternet\\Saklient\\Cloud\\Resource\\IsoImage", $server->instance->isoImage);
