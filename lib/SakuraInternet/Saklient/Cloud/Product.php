...
use \SakuraInternet\Saklient\Cloud\Model\Model_ServerPlan;
require_once dirname(__FILE__) . "/../../Saklient/Cloud/Model/Model_DiskPlan.php";
use \SakuraInternet\Saklient\Cloud\Model\Model_DiskPlan;
require_once dirname(__FILE__) . "/../../Saklient/Cloud/Model/Model_RouterPlan.php";
use \SakuraInternet\Saklient\Cloud\Model\Model_RouterPlan;
 ...
 * 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_ServerPlan $server サーバプラン情報。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_DiskPlan $disk ディスクプラン情報。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_RouterPlan $router ルータ帯域プラン情報。 
 */
class Product {
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_ServerPlan
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_DiskPlan
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_RouterPlan
	 */
	 ...
	 */
	public function __construct(\SakuraInternet\Saklient\Cloud\Client $client)
	{
