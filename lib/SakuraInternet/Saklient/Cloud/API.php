...
namespace SakuraInternet\Saklient\Cloud;
 ...
 * 
 * @see API.authorize
 * @property-read \SakuraInternet\Saklient\Cloud\Product $product 商品情報にアクセスするためのモデルを集めたオブジェクト。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Icon $icon アイコンにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Server $server サーバにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Disk $disk ディスクにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Appliance $appliance アプライアンスにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Archive $archive アーカイブにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_IsoImage $isoImage ISOイメージにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Iface $iface インタフェースにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Swytch $swytch スイッチにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Router $router ルータにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Ipv6Net $ipv6Net IPv6ネットワークにアクセスするためのモデル。 
 * @property-read \SakuraInternet\Saklient\Cloud\Model\Model_Script $script スクリプトにアクセスするためのモデル。 
 */
class API {
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Client
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Product
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_Disk
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_Appliance
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_Archive
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_Swytch
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_Router
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_Ipv6Net
	 */
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Model\Model_Script
	 */
	 ...
	 */
	protected function __construct(\SakuraInternet\Saklient\Cloud\Client $client)
	{
	 ...
	 * @return \SakuraInternet\Saklient\Cloud\API APIクライアント
	 */
