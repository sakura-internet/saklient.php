...
use \SakuraInternet\Saklient\Cloud\Resource\Script;
...
class DiskConfig {
	 ...
	 * @access protected
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Script[]
	 */
	 ...
	 */
	public function __construct(\SakuraInternet\Saklient\Cloud\Client $client, $diskId)
	{
	 ...
	 * 
	 * @access public
	 * @param \SakuraInternet\Saklient\Cloud\Resource\Script $script
	 * @return \SakuraInternet\Saklient\Cloud\Resource\DiskConfig this
	 */
	public function addScript(\SakuraInternet\Saklient\Cloud\Resource\Script $script)
	{
		Util::validateArgCount(func_num_args(), 1);
		Util::validateType($script, "\\SakuraInternet\\Saklient\\Cloud\\Resource\\Script");
	...
	public function __set($key, $v) {
		switch ($key) {
			...
			default: throw new SaklientException('non_writable_field', 'Non-writable field: SakuraInternet\\Saklient\\Cloud\\Resource\\DiskConfig#'.$key);
		}
	}
