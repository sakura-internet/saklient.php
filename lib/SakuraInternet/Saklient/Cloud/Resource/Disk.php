...
require_once dirname(__FILE__) . "/../../../Saklient/Cloud/Resource/DiskPlan.php";
use \SakuraInternet\Saklient\Cloud\Resource\DiskPlan;
require_once dirname(__FILE__) . "/../../../Saklient/Cloud/Resource/Server.php";
use \SakuraInternet\Saklient\Cloud\Resource\Server;
require_once dirname(__FILE__) . "/../../../Saklient/Cloud/Resource/DiskConfig.php";
use \SakuraInternet\Saklient\Cloud\Resource\DiskConfig;
require_once dirname(__FILE__) . "/../../../Saklient/Cloud/Enums/EAvailability.php";
use \SakuraInternet\Saklient\Cloud\Enums\EAvailability;
require_once dirname(__FILE__) . "/../../../Saklient/Cloud/Enums/EDiskConnection.php";
use \SakuraInternet\Saklient\Cloud\Enums\EDiskConnection;
 ...
 * @property \SakuraInternet\Saklient\Cloud\Resource\Resource $source ディスクのコピー元 
 ...
 * @property-read \SakuraInternet\Saklient\Cloud\Resource\DiskPlan $plan プラン 
 * @property-read \SakuraInternet\Saklient\Cloud\Resource\Server $server 接続先のサーバ 
...
class Disk extends Resource {
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Disk this
	 */
	 ...
	 * @access public
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Resource
	 */
	 ...
	 * @access public
	 * @ignore
	 * @param \SakuraInternet\Saklient\Cloud\Resource\Resource|null $source
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Resource
	 */
	public function set_source(\SakuraInternet\Saklient\Cloud\Resource\Resource $source=null)
	{
		Util::validateArgCount(func_num_args(), 1);
		Util::validateType($source, "\\SakuraInternet\\Saklient\\Cloud\\Resource\\Resource");
		$this->_source = $source;
		return $source;
	}
		...
		if ($r != null) {
			...
			if (array_key_exists("SourceArchive", $r)) {
				...
				if ($s != null) {
					$id = $s->{"ID"};
					if ($id != null) {
						$obj = Util::createClassInstance("saklient.cloud.resource.Archive", new \ArrayObject([$this->_client, $s]));
						$this->_source = $obj;
					}
				}
			}
	 ...
	 * 
	 * @access public
	 * @param \SakuraInternet\Saklient\Cloud\Resource\Server $server
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Disk this
	 */
	public function connectTo(\SakuraInternet\Saklient\Cloud\Resource\Server $server)
	{
		Util::validateArgCount(func_num_args(), 1);
		Util::validateType($server, "\\SakuraInternet\\Saklient\\Cloud\\Resource\\Server");
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\DiskConfig
	 */
	...
	private function set_sizeMib($v)
	{
		...
		if (!$this->isNew) {
			throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "SakuraInternet\\Saklient\\Cloud\\Resource\\Disk#sizeMib");
		}
		$this->m_sizeMib = $v;
		$this->n_sizeMib = true;
		return $this->m_sizeMib;
	 ...
	 * @access private
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Resource\DiskPlan
	 */
	 ...
	 * @access private
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Server
	 */
	...
	public function __set($key, $v) {
		switch ($key) {
			...
			default: throw new SaklientException('non_writable_field', 'Non-writable field: SakuraInternet\\Saklient\\Cloud\\Resource\\Disk#'.$key);
		}
	}
