...
use \SakuraInternet\Saklient\Cloud\Resource\Swytch;
require_once dirname(__FILE__) . "/../../../Saklient/Cloud/Resource/Ipv4Net.php";
use \SakuraInternet\Saklient\Cloud\Resource\Ipv4Net;
require_once dirname(__FILE__) . "/../../../Saklient/Cloud/Resource/Ipv6Net.php";
use \SakuraInternet\Saklient\Cloud\Resource\Ipv6Net;
...
class Router extends Resource {
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Router this
	 */
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Swytch
	 */
	public function getSwytch()
	{
		$model = Util::createClassInstance("saklient.cloud.model.Model_Swytch", new \ArrayObject([$this->_client]));
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Ipv6Net 有効化されたIPv6ネットワーク
	 */
	 ...
	 * 
	 * @access public
	 * @param \SakuraInternet\Saklient\Cloud\Resource\Ipv6Net $ipv6Net
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Router this
	 */
	public function removeIpv6Net(\SakuraInternet\Saklient\Cloud\Resource\Ipv6Net $ipv6Net)
	{
		Util::validateArgCount(func_num_args(), 1);
		Util::validateType($ipv6Net, "\\SakuraInternet\\Saklient\\Cloud\\Resource\\Ipv6Net");
	 ...
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Ipv4Net 追加されたスタティックルート
	 */
	 ...
	 * 
	 * @access public
	 * @param \SakuraInternet\Saklient\Cloud\Resource\Ipv4Net $ipv4Net
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Router this
	 */
	public function removeStaticRoute(\SakuraInternet\Saklient\Cloud\Resource\Ipv4Net $ipv4Net)
	{
		Util::validateArgCount(func_num_args(), 1);
		Util::validateType($ipv4Net, "\\SakuraInternet\\Saklient\\Cloud\\Resource\\Ipv4Net");
	...
	private function set_networkMaskLen($v)
	{
		...
		if (!$this->isNew) {
			throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "SakuraInternet\\Saklient\\Cloud\\Resource\\Router#networkMaskLen");
		}
	...
	private function set_bandWidthMbps($v)
	{
		...
		Util::validateType($v, "int");
		if (!$this->isNew) {
			throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "SakuraInternet\\Saklient\\Cloud\\Resource\\Router#bandWidthMbps");
		}
	...
	public function __set($key, $v) {
		switch ($key) {
			...
			default: throw new SaklientException('non_writable_field', 'Non-writable field: SakuraInternet\\Saklient\\Cloud\\Resource\\Router#'.$key);
		}
	}
