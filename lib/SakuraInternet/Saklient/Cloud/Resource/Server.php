...
use \SakuraInternet\Saklient\Cloud\Resource\Disk;
...
use \SakuraInternet\Saklient\Cloud\Resource\ServerInstance;
 ...
 * @property \SakuraInternet\Saklient\Cloud\Resource\ServerPlan $plan プラン 
 * @property-read \ArrayObject $ifaces インタフェース 
 * @property-read \SakuraInternet\Saklient\Cloud\Resource\ServerInstance $instance インスタンス情報 
...
class Server extends Resource {
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Server this
	 */
	 ...
	 * 
	 * @access public
	 * @param \SakuraInternet\Saklient\Cloud\Resource\ServerPlan $planTo
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Server this
	 */
	public function changePlan(\SakuraInternet\Saklient\Cloud\Resource\ServerPlan $planTo)
	{
		Util::validateArgCount(func_num_args(), 1);
		Util::validateType($planTo, "\\SakuraInternet\\Saklient\\Cloud\\Resource\\ServerPlan");
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Disk[]
	 */
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Iface 増設されたインタフェース
	 */
	 ...
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Server this
	 */
	public function insertIsoImage(\SakuraInternet\Saklient\Cloud\Resource\IsoImage $iso)
	{
		Util::validateArgCount(func_num_args(), 1);
	 ...
	 * @access private
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Resource\ServerPlan
	 */
	 ...
	 * @access private
	 * @ignore
	 * @param \SakuraInternet\Saklient\Cloud\Resource\ServerPlan $v
	 * @return \SakuraInternet\Saklient\Cloud\Resource\ServerPlan
	 */
	private function set_plan(\SakuraInternet\Saklient\Cloud\Resource\ServerPlan $v)
	{
		Util::validateArgCount(func_num_args(), 1);
		Util::validateType($v, "\\SakuraInternet\\Saklient\\Cloud\\Resource\\ServerPlan");
		if (!$this->isNew) {
			throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "SakuraInternet\\Saklient\\Cloud\\Resource\\Server#plan");
		}
		$this->m_plan = $v;
		$this->n_plan = true;
		return $this->m_plan;
	 ...
	 * @access private
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Iface[]
	 */
	 ...
	 * @access private
	 * @ignore
	 * @return \SakuraInternet\Saklient\Cloud\Resource\ServerInstance
	 */
	...
	public function __set($key, $v) {
		switch ($key) {
			...
			default: throw new SaklientException('non_writable_field', 'Non-writable field: SakuraInternet\\Saklient\\Cloud\\Resource\\Server#'.$key);
		}
	}
