...
use \SakuraInternet\Saklient\Cloud\Enums\EApplianceClass;
...
class Appliance extends Resource {
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Appliance this
	 */
	...
	private function set_clazz($v)
	{
		...
		if (!$this->isNew) {
			throw new SaklientException("immutable_field", "Immutable fields cannot be modified after the resource creation: " . "SakuraInternet\\Saklient\\Cloud\\Resource\\Appliance#clazz");
		}
		$this->m_clazz = $v;
		$this->n_clazz = true;
		return $this->m_clazz;
	...
	public function __set($key, $v) {
		switch ($key) {
			...
			default: throw new SaklientException('non_writable_field', 'Non-writable field: SakuraInternet\\Saklient\\Cloud\\Resource\\Appliance#'.$key);
		}
	}
