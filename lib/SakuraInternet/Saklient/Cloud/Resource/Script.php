...
use \SakuraInternet\Saklient\Cloud\Enums\EScriptClass;
...
class Script extends Resource {
	 ...
	 * 
	 * @access public
	 * @return \SakuraInternet\Saklient\Cloud\Resource\Script this
	 */
	...
	public function __set($key, $v) {
		switch ($key) {
			...
			default: throw new SaklientException('non_writable_field', 'Non-writable field: SakuraInternet\\Saklient\\Cloud\\Resource\\Script#'.$key);
		}
	}
