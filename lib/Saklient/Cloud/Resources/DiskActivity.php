...
require_once __DIR__ . "/../../../Saklient/Cloud/Resources/DiskActivitySample.php";
...
class DiskActivity extends Activity {
	 ...
	 * @access protected
	 * @ignore
	 * @return \Saklient\Cloud\Resources\DiskActivitySample[]
	 */
	...
	protected function _addSample($atStr, $data)
	{
		...
		$this->_samples->append(new DiskActivitySample($atStr, $data));
	}
