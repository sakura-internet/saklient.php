...
require_once __DIR__ . "/../../../Saklient/Cloud/Resources/Sshkey.php";
use \Saklient\Cloud\Resources\Sshkey;
require_once __DIR__ . "/../../../Saklient/Util.php";
use \Saklient\Util;
require_once __DIR__ . "/../../../Saklient/Errors/SaklientException.php";
use \Saklient\Errors\SaklientException;

/** SSHKeyを検索・作成するための機能を備えたクラス。 */
class Model_Sshkey extends Model {
	...
	protected function _createResourceImpl($obj, $wrapped=false)
	{
		...
		return new Sshkey($this->_client, $obj, $wrapped);
	}
	 ...
	 * @return \Saklient\Cloud\Models\Model_Sshkey this
	 */
	 ...
	 * @return \Saklient\Cloud\Models\Model_Sshkey
	 */
	 ...
	 * 
	 * @access public
	 * @return \Saklient\Cloud\Resources\Sshkey リソースオブジェクト
	 */
	 ...
	 * 
	 * @access public
	 * @return \Saklient\Cloud\Resources\Sshkey[] リソースオブジェクトの配列
	 */
