...
class DiskConfig {
	 ...
	 * @access protected
	 * @ignore
	 * @return \Saklient\Cloud\Resource\Script[]
	 */
	 ...
	 * 
	 * @access public
	 * @param \Saklient\Cloud\Resource\Script $script
	 * @return \Saklient\Cloud\Resource\DiskConfig this
	 */
	public function addScript(\Saklient\Cloud\Resource\Script $script)
	{
		Util::validateArgCount(func_num_args(), 1);
	...
	public function __set($key, $v) {
		switch ($key) {
			...
			default: throw new SaklientException('non_writable_field', 'Non-writable field: Saklient\\Cloud\\Resource\\DiskConfig#'.$key);
		}
	}
