...
class Appliance extends Resource {
	 ...
	 * 
	 * @access public
	 * @return \Saklient\Cloud\Resource\Appliance this
	 */
	...
	public function __set($key, $v) {
		switch ($key) {
			...
			default: throw new SaklientException('non_writable_field', 'Non-writable field: Saklient\\Cloud\\Resource\\Appliance#'.$key);
		}
	}
